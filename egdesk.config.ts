 ...
 * Generated at: 2026-06-20T13:16:14.986Z
 *
...
export const TABLES = {
  ...
  table112: {
    ...
    rowCount: 0,
    columnCount: 7,
    columns: ['id', 'title', 'agency', 'match_score', 'match_guide', 'budget', 'end_date']
  } as TableDefinition,
  table113: {
...
export const TABLE_NAMES = {
  table1: 'crm_meeting_tasks',
  table2: 'crm_meetings',
  table3: 'exchange_rates',
  table4: 'exchange_rate_histories',
  table5: 'tenant_menu_settings',
  table6: 'user_feedbacks',
  table7: 'crm_attendance',
  table8: 'crm_annual_leaves',
  table9: 'crm_operator_leave_balances',
  table10: 'crm_company_events',
  table11: 'crm_operator_contract_settings',
  table12: 'crm_operator_profiles',
  table13: 'crm_operator_education',
  table14: 'crm_operator_licenses',
  table15: 'crm_operator_careers',
  table16: 'crm_operator_salaries',
  table17: 'crm_operator_promotions',
  table18: 'crm_operator_awards',
  table19: 'crm_operator_family_events',
  table20: 'crm_operator_medical',
  table21: 'crm_operator_incidents',
  table22: 'crm_operator_reputations',
  table23: 'crm_operator_families',
  table24: 'crm_operator_job_history',
  table25: 'crm_operator_projects',
  table26: 'crm_operator_ai_briefing_histories',
  table27: 'crm_company_event_types',
  table28: 'ecount_sync_schedules',
  table29: 'ecount_rpa_lock',
  table30: 'pms_projects',
  table31: 'crm_energy_savings',
  table32: 'crm_energy_equipments',
  table33: 'crm_safety_alerts',
  table34: 'crm_safety_zones',
  table35: 'crm_scm_shipments',
  table36: 'crm_scm_suppliers',
  table37: 'crm_labor_stats',
  table38: 'crm_labor_contracts',
  table39: 'crm_partner_credit_risks',
  table40: 'crm_production_gantt_tasks',
  table41: 'crm_production_unscheduled_orders',
  table42: 'crm_production_bottlenecks',
  table43: 'crm_production_due_risk',
  table44: 'crm_facility_events',
  table45: 'crm_facility_parts',
  table46: 'crm_facility_oee_stats',
  table47: 'crm_facility_oee_downtime',
  table48: 'crm_facility_layout',
  table49: 'crm_finance_products',
  table50: 'crm_finance_forecasts',
  table51: 'crm_customers',
  table52: 'system_settings',
  table53: 'crm_web_templates',
  table54: 'crm_web_form_logs',
  table55: 'message_templates',
  table56: 'message_logs',
  table57: 'ad_templates',
  table58: 'products',
  table59: 'crm_transactions',
  table60: 'crm_orders',
  table61: 'crm_payments',
  table62: 'crm_reservations',
  table63: 'crm_deliveries',
  table64: 'crm_operators',
  table65: 'crm_instagram_posts',
  table66: 'instagram_marketing_settings',
  table67: 'crm_naver_blog_posts',
  table68: 'naver_blog_marketing_settings',
  table69: 'coupons',
  table70: 'crm_coupons_restrictions',
  table71: 'crm_point_history',
  table72: 'crm_estimates',
  table73: 'crm_estimate_items',
  table74: 'crm_purchase_orders',
  table75: 'crm_sales_orders',
  table76: 'crm_partners',
  table77: 'crm_snaptasks',
  table78: 'crm_snaptask_items',
  table79: 'crm_snaptask_actions',
  table80: 'crm_partner_contacts',
  table81: 'inventory_items',
  table82: 'crm_inventory_inbounds',
  table83: 'crm_inventory_inbound_items',
  table84: 'ai_token_usage_logs',
  table85: 'tracked_items',
  table86: 'target_urls',
  table87: 'price_histories',
  table88: 'alert_rules',
  table89: 'alert_logs',
  table90: 'inventory_logs',
  table91: 'crm_expenses',
  table92: 'expense_settings',
  table93: 'expense_categories',
  table94: 'expense_tags',
  table95: 'expense_departments',
  table96: 'expense_employees',
  table97: 'expense_projects',
  table98: 'shared_dashboards',
  table99: 'system_menu_settings',
  table100: 'system_mail_logs',
  table101: 'ai_contextual_help',
  table102: 'form_templates',
  table103: 'form_mappings',
  table104: 'crm_employment_certificate_logs',
  table105: 'safety_policies',
  table106: 'safety_risk_assessments',
  table107: 'safety_tbm_logs',
  table108: 'safety_near_misses',
  table109: 'safety_inspect_logs',
  table110: 'crm_financial_statements',
  table111: 'crm_recruitment_applicants',
  table112: 'crm_grant_announcements',
  table113: 'crm_grant_bookmarks',
  table114: 'crm_grant_rnd_plans',
  table115: 'crm_grant_company_profile',
  table116: 'crm_quality_checklist_submissions',
  table117: 'crm_quality_ncr_items',
  table118: 'crm_quality_ncr_similar_cases',
  table119: 'crm_quality_sensors_status',
  table120: 'crm_quality_sensors_contribution',
  table121: 'crm_quality_sensors_timeline',
  table122: 'crm_quality_spc_config',
  table123: 'crm_quality_spc_samples',
  table124: 'crm_quality_spc_predictions',
  table125: 'crm_quality_spc_features',
  table126: 'crm_quality_vision_model',
  table127: 'crm_quality_vision_logs',
  table128: 'crm_facilities',
  table129: 'crm_facility_checklists',
  table130: 'crm_facility_repair_logs',
  table131: 'crm_facility_repair_solutions',
  table132: 'crm_facility_predictive_summary',
  table133: 'crm_facility_predictive_vibration',
  table134: 'crm_facility_predictive_fft',
  table135: 'crm_facility_predictive_part_rul',
  table136: 'rnd_centers',
  table137: 'rnd_staffs',
  table138: 'rnd_spaces',
  table139: 'rnd_logs',
  table140: 'rnd_compliance_alarms',
  table141: 'crm_credential_vault',
  table142: 'crm_credential_emergency_requests',
  table143: 'crm_credential_audit_logs'
} as const;
