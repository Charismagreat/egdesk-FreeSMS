 ...
 * Generated at: 2026-07-03T00:44:06.501Z
 *
...
export const TABLES = {
  table1: {
    ...
    rowCount: 1,
    columnCount: 25,
    columns: ['id', 'type', 'company_name', 'business_number', 'representative', 'phone', 'fax', 'manager_name', 'manager_phone', 'manager_position', 'manager_email', 'email', 'address', 'vip_level', 'credit_limit', 'business_license_url', 'memo', 'created_at', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table2: {
    ...
    rowCount: 0,
    columnCount: 13,
    columns: ['id', 'header_signature', 'partner_name', 'is_auto_approve', 'mapping_info', 'created_at', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table3: {
    ...
    rowCount: 1,
    columnCount: 14,
    columns: ['id', 'header_signature', 'partner_name', 'transaction_type', 'is_auto_approve', 'mapping_info', 'created_at', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table4: {
    ...
    rowCount: 2,
    columnCount: 14,
    columns: ['id', 'partner_name', 'inbound_date', 'total_amount', 'pdf_file_path', 'file_hash', 'created_at', 'updated_at', 'uuid', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table5: {
    ...
    rowCount: 0,
    columnCount: 15,
    columns: ['id', 'doc_type', 'doc_id', 'doc_title', 'status', 'reason', 'operator', 'created_at', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table6: {
...
export const TABLE_NAMES = {
  table1: 'crm_partners',
  table2: 'crm_inbound_excel_signatures',
  table3: 'crm_excel_signatures',
  table4: 'crm_inventory_inbounds',
  table5: 'crm_governance_logs',
  table6: 'rnd_compliance_alarms',
  table7: 'rnd_logs',
  table8: 'rnd_spaces',
  table9: 'rnd_staffs',
  table10: 'rnd_centers',
  table11: 'crm_facility_predictive_part_rul',
  table12: 'crm_facility_predictive_fft',
  table13: 'crm_facility_predictive_vibration',
  table14: 'crm_facility_predictive_summary',
  table15: 'crm_facility_repair_solutions',
  table16: 'crm_facility_repair_logs',
  table17: 'crm_facility_checklists',
  table18: 'crm_facilities',
  table19: 'crm_quality_vision_logs',
  table20: 'crm_quality_vision_model',
  table21: 'crm_quality_spc_features',
  table22: 'crm_quality_spc_predictions',
  table23: 'crm_quality_spc_samples',
  table24: 'crm_quality_spc_config',
  table25: 'crm_quality_sensors_timeline',
  table26: 'crm_quality_sensors_contribution',
  table27: 'crm_quality_sensors_status',
  table28: 'crm_quality_ncr_similar_cases',
  table29: 'crm_quality_ncr_items',
  table30: 'crm_quality_checklist_submissions',
  table31: 'crm_grant_company_profile',
  table32: 'crm_grant_rnd_plans',
  table33: 'crm_grant_bookmarks',
  table34: 'crm_recruitment_applicants',
  table35: 'crm_financial_analysis_logs',
  table36: 'crm_financial_statement_items',
  table37: 'crm_financial_statements',
  table38: 'safety_inspect_logs',
  table39: 'safety_near_misses',
  table40: 'safety_tbm_logs',
  table41: 'safety_risk_assessments',
  table42: 'safety_policies',
  table43: 'ai_contextual_help',
  table44: 'system_mail_logs',
  table45: 'system_menu_settings',
  table46: 'shared_dashboards',
  table47: 'expense_employees',
  table48: 'expense_departments',
  table49: 'expense_tags',
  table50: 'expense_categories',
  table51: 'expense_settings',
  table52: 'inventory_logs',
  table53: 'alert_logs',
  table54: 'alert_rules',
  table55: 'price_histories',
  table56: 'target_urls',
  table57: 'tracked_items',
  table58: 'crm_inventory_inbound_items',
  table59: 'crm_partner_contacts',
  table60: 'crm_snaptask_actions',
  table61: 'crm_snaptask_items',
  table62: 'crm_snaptasks',
  table63: 'crm_sales_orders',
  table64: 'crm_purchase_orders',
  table65: 'crm_point_history',
  table66: 'crm_coupons_restrictions',
  table67: 'naver_blog_marketing_settings',
  table68: 'crm_naver_blog_posts',
  table69: 'instagram_marketing_settings',
  table70: 'crm_instagram_posts',
  table71: 'crm_operators',
  table72: 'system_settings',
  table73: 'crm_transactions',
  table74: 'ad_templates',
  table75: 'message_logs',
  table76: 'message_templates',
  table77: 'crm_customers',
  table78: 'crm_expenses',
  table79: 'crm_estimate_items',
  table80: 'crm_estimates',
  table81: 'crm_partner_ai_reports',
  table82: 'crm_grant_announcements',
  table83: 'system_shared_views',
  table84: 'user_data_embedding_metadata',
  table85: 'user_data_embeddings',
  table86: 'sync_activity_log',
  table87: 'sync_configurations',
  table88: 'user_data_files',
  table89: 'crm_interpretation_logs',
  table90: 'crm_interpretation_sessions',
  table91: 'easybot_rules_history',
  table92: 'easybot_rules',
  table93: 'easybot_action_audit_logs',
  table94: 'crm_web_published_sites',
  table95: 'crm_deadstock_proposals',
  table96: 'crm_meeting_tasks',
  table97: 'crm_meetings',
  table98: 'exchange_rates',
  table99: 'tenant_menu_settings',
  table100: 'exchange_rate_histories',
  table101: 'user_feedbacks',
  table102: 'crm_attendance',
  table103: 'crm_operator_leave_balances',
  table104: 'crm_annual_leaves',
  table105: 'crm_company_events',
  table106: 'crm_operator_contract_settings',
  table107: 'crm_operator_profiles',
  table108: 'crm_operator_licenses',
  table109: 'crm_operator_education',
  table110: 'crm_operator_careers',
  table111: 'crm_operator_salaries',
  table112: 'crm_operator_awards',
  table113: 'crm_operator_promotions',
  table114: 'crm_operator_family_events',
  table115: 'crm_operator_incidents',
  table116: 'crm_operator_medical',
  table117: 'crm_operator_reputations',
  table118: 'crm_operator_families',
  table119: 'crm_operator_job_history',
  table120: 'crm_operator_ai_briefing_histories',
  table121: 'crm_operator_projects',
  table122: 'crm_company_event_types',
  table123: 'ecount_sync_schedules',
  table124: 'pms_projects',
  table125: 'ecount_rpa_lock',
  table126: 'crm_energy_savings',
  table127: 'crm_safety_alerts',
  table128: 'crm_energy_equipments',
  table129: 'crm_safety_zones',
  table130: 'crm_scm_shipments',
  table131: 'crm_labor_stats',
  table132: 'crm_scm_suppliers',
  table133: 'crm_labor_contracts',
  table134: 'crm_partner_credit_risks',
  table135: 'crm_production_gantt_tasks',
  table136: 'crm_production_bottlenecks',
  table137: 'crm_production_unscheduled_orders',
  table138: 'crm_production_due_risk',
  table139: 'crm_facility_events',
  table140: 'crm_facility_parts',
  table141: 'crm_facility_oee_downtime',
  table142: 'crm_facility_oee_stats',
  table143: 'crm_facility_layout',
  table144: 'crm_finance_products',
  table145: 'crm_finance_forecasts',
  table146: 'crm_web_templates',
  table147: 'crm_web_form_logs',
  table148: 'products',
  table149: 'crm_orders',
  table150: 'crm_reservations',
  table151: 'crm_payments',
  table152: 'crm_deliveries',
  table153: 'coupons',
  table154: 'inventory_items',
  table155: 'ai_token_usage_logs',
  table156: 'expense_projects',
  table157: 'form_templates',
  table158: 'crm_employment_certificate_logs',
  table159: 'form_mappings',
  table160: 'crm_credential_vault',
  table161: 'crm_credential_emergency_requests',
  table162: 'crm_credential_audit_logs'
} as const;
