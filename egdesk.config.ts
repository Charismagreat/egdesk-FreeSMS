 ...
 * Generated at: 2026-06-29T06:10:54.647Z
 *
...
export const TABLES = {
  ...
  table16: {
    ...
    rowCount: 0,
    columnCount: 15,
    columns: ['id', 'rate_id', 'currency_code', 'currency_name', 'current_rate', 'change_rate', 'change_direction', 'last_updated_at', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table17: {
    ...
    rowCount: 0,
    columnCount: 12,
    columns: ['id', 'history_id', 'currency_code', 'rate_value', 'captured_date', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table18: {
    ...
    rowCount: 0,
    columnCount: 12,
    columns: ['id', 'tenant_id', 'menu_href', 'is_enabled', 'sort_order', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table19: {
    name: 'user_feedbacks',
    ...
    rowCount: 0,
    columnCount: 13,
    columns: ['id', 'user_prompt', 'detected_type', 'current_url', 'resolved_status', 'created_at', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table20: {
    name: 'crm_attendance',
    ...
    rowCount: 0,
    columnCount: 16,
    columns: ['id', 'operator_id', 'work_date', 'clock_in', 'clock_out', 'status', 'working_hours', 'memo', 'created_at', 'updated_at', 'uuid', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table21: {
    ...
    rowCount: 0,
    columnCount: 18,
    columns: ['id', 'operator_id', 'leave_type', 'start_date', 'end_date', 'days_spent', 'status', 'reason', 'reject_reason', 'approver_id', 'created_at', 'updated_at', 'uuid', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table22: {
    ...
    rowCount: 0,
    columnCount: 12,
    columns: ['id', 'operator_id', 'total_allowed', 'used', 'remaining', 'updated_at', 'uuid', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table23: {
    ...
    rowCount: 0,
    columnCount: 15,
    columns: ['id', 'title', 'start_date', 'end_date', 'event_type', 'description', 'created_by', 'created_at', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table24: {
    ...
    rowCount: 0,
    columnCount: 14,
    columns: ['id', 'operator_id', 'hourly_wage', 'weekly_hours', 'allow_weekly_holiday_paid', 'work_days', 'contract_memo', 'updated_at', 'uuid', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table25: {
    ...
    rowCount: 0,
    columnCount: 14,
    columns: ['id', 'operator_id', 'department', 'hire_date', 'commute_area', 'skills', 'backup_operator_id', 'updated_at', 'uuid', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table26: {
    ...
    rowCount: 0,
    columnCount: 15,
    columns: ['id', 'operator_id', 'school_name', 'major', 'degree', 'entrance_date', 'graduation_date', 'status', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table27: {
    ...
    rowCount: 0,
    columnCount: 14,
    columns: ['id', 'operator_id', 'license_name', 'issuer', 'license_no', 'acquisition_date', 'expiry_date', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table28: {
    ...
    rowCount: 0,
    columnCount: 16,
    columns: ['id', 'operator_id', 'company_name', 'department', 'job_title', 'join_date', 'retire_date', 'assigned_task', 'leaving_reason', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table29: {
    ...
    rowCount: 0,
    columnCount: 19,
    columns: ['id', 'operator_id', 'payment_year_month', 'base_salary', 'bonus_amount', 'weekly_holiday_allowance', 'overtime_allowance', 'meal_allowance', 'deduction_amount', 'net_salary', 'payment_date', 'status', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table30: {
    ...
    rowCount: 0,
    columnCount: 15,
    columns: ['id', 'operator_id', 'change_date', 'prev_dept', 'next_dept', 'prev_role', 'next_role', 'promotion_reason', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table31: {
    ...
    rowCount: 0,
    columnCount: 15,
    columns: ['id', 'operator_id', 'record_date', 'type', 'title', 'content', 'authority', 'remarks', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table32: {
    ...
    rowCount: 0,
    columnCount: 14,
    columns: ['id', 'operator_id', 'event_date', 'relation', 'type', 'congratulation_money', 'wreath_provided', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table33: {
    ...
    rowCount: 0,
    columnCount: 15,
    columns: ['id', 'operator_id', 'diagnosis_name', 'treatment_start_date', 'treatment_end_date', 'hospital_name', 'sick_leave_days', 'work_limitations', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table34: {
    ...
    rowCount: 0,
    columnCount: 15,
    columns: ['id', 'operator_id', 'occurred_date', 'severity', 'title', 'description', 'status', 'outcome', 'updated_at', 'uuid', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table35: {
    ...
    rowCount: 0,
    columnCount: 15,
    columns: ['id', 'operator_id', 'evaluation_date', 'evaluator_id', 'source_type', 'score', 'positive_feedback', 'constructive_feedback', 'updated_at', 'uuid', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table36: {
    ...
    rowCount: 0,
    columnCount: 15,
    columns: ['id', 'operator_id', 'relation_type', 'name', 'birth_date', 'phone_number', 'is_dependent', 'remarks', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table37: {
    ...
    rowCount: 0,
    columnCount: 13,
    columns: ['id', 'operator_id', 'assignment_date', 'job_description', 'prev_job_description', 'is_current', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table38: {
    ...
    rowCount: 0,
    columnCount: 17,
    columns: ['id', 'operator_id', 'project_name', 'role_in_project', 'start_date', 'end_date', 'contribution_rate', 'performance_score', 'performance_evaluation', 'outcome_link', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table39: {
    ...
    rowCount: 0,
    columnCount: 17,
    columns: ['id', 'target_year_month', 'risk_score', 'alert_title', 'alert_message', 'briefing_text', 'created_at', 'created_by', 'token_usage_input', 'token_usage_output', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table40: {
    ...
    rowCount: 0,
    columnCount: 13,
    columns: ['id', 'type_key', 'type_name', 'color_theme', 'is_system', 'created_at', 'updated_at', 'uuid', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table41: {
    ...
    rowCount: 0,
    columnCount: 17,
    columns: ['id', 'script_file', 'script_title', 'target_table', 'period_preset', 'run_time', 'is_active', 'last_run_at', 'next_run_at', 'created_at', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table42: {
    ...
    rowCount: 0,
    columnCount: 12,
    columns: ['id', 'is_locked', 'locked_by', 'locked_at', 'cooldown_until', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table43: {
    name: 'pms_projects',
    ...
    rowCount: 0,
    columnCount: 20,
    columns: ['id', 'client', 'bizNo', 'name', 'type', 'dueDate', 'folderUrl', 'estimateUrl', 'status', 'createdAt', 'details', 'processStep', 'inboundChannel', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table44: {
    ...
    rowCount: 0,
    columnCount: 11,
    columns: ['id', 'apply_date', 'saving_amount', 'is_active', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table45: {
    ...
    rowCount: 0,
    columnCount: 12,
    columns: ['id', 'equipment_name', 'status', 'current_load', 'monthly_bill', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table46: {
    ...
    rowCount: 0,
    columnCount: 13,
    columns: ['id', 'zone_name', 'alert_level', 'detector_type', 'created_at', 'is_resolved', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table47: {
    ...
    rowCount: 0,
    columnCount: 11,
    columns: ['id', 'zone_name', 'risk_score', 'status', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table48: {
    ...
    rowCount: 0,
    columnCount: 14,
    columns: ['id', 'item_name', 'supplier_name', 'status', 'eta', 'delay_probability', 'current_step', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table49: {
    ...
    rowCount: 0,
    columnCount: 12,
    columns: ['id', 'supplier_name', 'delivery_rate', 'defect_rate', 'score', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table50: {
    ...
    rowCount: 0,
    columnCount: 13,
    columns: ['id', 'weekly_hours', 'overtime_hours', 'lateness_count', 'early_leave_count', 'risk_level', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table51: {
    ...
    rowCount: 0,
    columnCount: 14,
    columns: ['id', 'clause_id', 'title', 'is_illegal', 'current_text', 'recommended_text', 'reason', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table52: {
    ...
    rowCount: 0,
    columnCount: 15,
    columns: ['id', 'overdue_amount', 'overdue_days', 'credit_rating', 'default_probability', 'risk_level', 'last_action', 'action_date', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table53: {
    ...
    rowCount: 0,
    columnCount: 16,
    columns: ['id', 'title', 'equipmentId', 'equipmentName', 'operatorName', 'startHour', 'endHour', 'progress', 'status', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table54: {
    ...
    rowCount: 0,
    columnCount: 13,
    columns: ['id', 'orderId', 'productName', 'qty', 'dueDate', 'status', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table55: {
    ...
    rowCount: 0,
    columnCount: 12,
    columns: ['id', 'name', 'loadRate', 'status', 'queueTasks', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table56: {
    ...
    rowCount: 0,
    columnCount: 12,
    columns: ['id', 'orderId', 'productName', 'probability', 'status', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table57: {
    ...
    rowCount: 0,
    columnCount: 12,
    columns: ['id', 'date', 'title', 'type', 'assignee', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table58: {
    ...
    rowCount: 0,
    columnCount: 14,
    columns: ['id', 'name', 'safetyStock', 'currentStock', 'unit', 'leadTimeDays', 'risk', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table59: {
    ...
    rowCount: 0,
    columnCount: 18,
    columns: ['id', 'overallOee', 'availability', 'performance', 'quality', 'totalLoaded', 'actualRun', 'plannedStop', 'breakdownStop', 'opportunityLossKrw', 'preventedLossKrw', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table60: {
    ...
    rowCount: 0,
    columnCount: 11,
    columns: ['id', 'reason', 'minutes', 'rate', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table61: {
    ...
    rowCount: 0,
    columnCount: 13,
    columns: ['id', 'name', 'status', 'oee', 'x', 'y', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table62: {
    ...
    rowCount: 0,
    columnCount: 14,
    columns: ['id', 'productId', 'productName', 'rawMaterialCost', 'laborCost', 'expenseCost', 'sellingPrice', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table63: {
    ...
    rowCount: 0,
    columnCount: 15,
    columns: ['id', 'date', 'type', 'title', 'partnerName', 'amount', 'isOverdue', 'contact', 'uuid', 'updated_at', 'updated_by', 'deleted_at', 'deleted_by', 'restored_at', 'restored_by']
  } as TableDefinition,
  table64: {
    name: 'crm_customers',
    displayName: '고객 명단',
...
export const TABLE_NAMES = {
  table1: 'crm_expenses',
  table2: 'crm_sales_orders',
  table3: 'crm_estimate_items',
  table4: 'crm_interpretation_logs',
  table5: 'crm_interpretation_sessions',
  table6: 'easybot_rules_history',
  table7: 'easybot_rules',
  table8: 'crm_financial_analysis_logs',
  table9: 'crm_financial_statement_items',
  table10: 'crm_partner_ai_reports',
  table11: 'easybot_action_audit_logs',
  table12: 'crm_web_published_sites',
  table13: 'crm_deadstock_proposals',
  table14: 'crm_meeting_tasks',
  table15: 'crm_meetings',
  table16: 'exchange_rates',
  table17: 'exchange_rate_histories',
  table18: 'tenant_menu_settings',
  table19: 'user_feedbacks',
  table20: 'crm_attendance',
  table21: 'crm_annual_leaves',
  table22: 'crm_operator_leave_balances',
  table23: 'crm_company_events',
  table24: 'crm_operator_contract_settings',
  table25: 'crm_operator_profiles',
  table26: 'crm_operator_education',
  table27: 'crm_operator_licenses',
  table28: 'crm_operator_careers',
  table29: 'crm_operator_salaries',
  table30: 'crm_operator_promotions',
  table31: 'crm_operator_awards',
  table32: 'crm_operator_family_events',
  table33: 'crm_operator_medical',
  table34: 'crm_operator_incidents',
  table35: 'crm_operator_reputations',
  table36: 'crm_operator_families',
  table37: 'crm_operator_job_history',
  table38: 'crm_operator_projects',
  table39: 'crm_operator_ai_briefing_histories',
  table40: 'crm_company_event_types',
  table41: 'ecount_sync_schedules',
  table42: 'ecount_rpa_lock',
  table43: 'pms_projects',
  table44: 'crm_energy_savings',
  table45: 'crm_energy_equipments',
  table46: 'crm_safety_alerts',
  table47: 'crm_safety_zones',
  table48: 'crm_scm_shipments',
  table49: 'crm_scm_suppliers',
  table50: 'crm_labor_stats',
  table51: 'crm_labor_contracts',
  table52: 'crm_partner_credit_risks',
  table53: 'crm_production_gantt_tasks',
  table54: 'crm_production_unscheduled_orders',
  table55: 'crm_production_bottlenecks',
  table56: 'crm_production_due_risk',
  table57: 'crm_facility_events',
  table58: 'crm_facility_parts',
  table59: 'crm_facility_oee_stats',
  table60: 'crm_facility_oee_downtime',
  table61: 'crm_facility_layout',
  table62: 'crm_finance_products',
  table63: 'crm_finance_forecasts',
  table64: 'crm_customers',
  table65: 'system_settings',
  table66: 'crm_web_templates',
  table67: 'crm_web_form_logs',
  table68: 'message_templates',
  table69: 'message_logs',
  table70: 'ad_templates',
  table71: 'products',
  table72: 'crm_transactions',
  table73: 'crm_orders',
  table74: 'crm_payments',
  table75: 'crm_reservations',
  table76: 'crm_deliveries',
  table77: 'crm_operators',
  table78: 'crm_instagram_posts',
  table79: 'instagram_marketing_settings',
  table80: 'crm_naver_blog_posts',
  table81: 'naver_blog_marketing_settings',
  table82: 'coupons',
  table83: 'crm_coupons_restrictions',
  table84: 'crm_point_history',
  table85: 'crm_estimates',
  table86: 'crm_purchase_orders',
  table87: 'crm_partners',
  table88: 'crm_snaptasks',
  table89: 'crm_snaptask_items',
  table90: 'crm_snaptask_actions',
  table91: 'crm_partner_contacts',
  table92: 'inventory_items',
  table93: 'crm_inventory_inbounds',
  table94: 'crm_inventory_inbound_items',
  table95: 'ai_token_usage_logs',
  table96: 'tracked_items',
  table97: 'target_urls',
  table98: 'price_histories',
  table99: 'alert_rules',
  table100: 'alert_logs',
  table101: 'inventory_logs',
  table102: 'expense_settings',
  table103: 'expense_categories',
  table104: 'expense_tags',
  table105: 'expense_departments',
  table106: 'expense_employees',
  table107: 'expense_projects',
  table108: 'shared_dashboards',
  table109: 'system_menu_settings',
  table110: 'system_mail_logs',
  table111: 'ai_contextual_help',
  table112: 'form_templates',
  table113: 'form_mappings',
  table114: 'crm_employment_certificate_logs',
  table115: 'safety_policies',
  table116: 'safety_risk_assessments',
  table117: 'safety_tbm_logs',
  table118: 'safety_near_misses',
  table119: 'safety_inspect_logs',
  table120: 'crm_financial_statements',
  table121: 'crm_recruitment_applicants',
  table122: 'crm_grant_announcements',
  table123: 'crm_grant_bookmarks',
  table124: 'crm_grant_rnd_plans',
  table125: 'crm_grant_company_profile',
  table126: 'crm_quality_checklist_submissions',
  table127: 'crm_quality_ncr_items',
  table128: 'crm_quality_ncr_similar_cases',
  table129: 'crm_quality_sensors_status',
  table130: 'crm_quality_sensors_contribution',
  table131: 'crm_quality_sensors_timeline',
  table132: 'crm_quality_spc_config',
  table133: 'crm_quality_spc_samples',
  table134: 'crm_quality_spc_predictions',
  table135: 'crm_quality_spc_features',
  table136: 'crm_quality_vision_model',
  table137: 'crm_quality_vision_logs',
  table138: 'crm_facilities',
  table139: 'crm_facility_checklists',
  table140: 'crm_facility_repair_logs',
  table141: 'crm_facility_repair_solutions',
  table142: 'crm_facility_predictive_summary',
  table143: 'crm_facility_predictive_vibration',
  table144: 'crm_facility_predictive_fft',
  table145: 'crm_facility_predictive_part_rul',
  table146: 'rnd_centers',
  table147: 'rnd_staffs',
  table148: 'rnd_spaces',
  table149: 'rnd_logs',
  table150: 'rnd_compliance_alarms',
  table151: 'crm_credential_vault',
  table152: 'crm_credential_emergency_requests',
  table153: 'crm_credential_audit_logs'
} as const;
