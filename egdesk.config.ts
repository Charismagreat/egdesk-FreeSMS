 ...
 * Generated at: 2026-06-17T10:29:28.397Z
 *
...
export const TABLE_NAMES = {
  table1: 'crm_expenses',
  table2: 'easybot_rules_history',
  table3: 'easybot_rules',
  table4: 'crm_financial_analysis_logs',
  table5: 'crm_financial_statement_items',
  table6: 'easybot_action_audit_logs',
  table7: 'crm_web_published_sites',
  table8: 'crm_meeting_tasks',
  table9: 'crm_meetings',
  table10: 'crm_deadstock_proposals',
  table11: 'crm_credential_audit_logs',
  table12: 'crm_credential_emergency_requests',
  table13: 'crm_credential_vault',
  table14: 'rnd_compliance_alarms',
  table15: 'rnd_logs',
  table16: 'rnd_spaces',
  table17: 'rnd_staffs',
  table18: 'rnd_centers',
  table19: 'crm_facility_predictive_part_rul',
  table20: 'crm_facility_predictive_fft',
  table21: 'crm_facility_predictive_vibration',
  table22: 'crm_facility_predictive_summary',
  table23: 'crm_facility_repair_solutions',
  table24: 'crm_facility_repair_logs',
  table25: 'crm_facility_checklists',
  table26: 'crm_facilities',
  table27: 'crm_quality_vision_logs',
  table28: 'crm_quality_vision_model',
  table29: 'crm_quality_spc_features',
  table30: 'crm_quality_spc_predictions',
  table31: 'crm_quality_spc_samples',
  table32: 'crm_quality_spc_config',
  table33: 'crm_quality_sensors_timeline',
  table34: 'crm_quality_sensors_contribution',
  table35: 'crm_quality_sensors_status',
  table36: 'crm_quality_ncr_similar_cases',
  table37: 'crm_quality_ncr_items',
  table38: 'crm_quality_checklist_submissions',
  table39: 'crm_grant_company_profile',
  table40: 'crm_grant_rnd_plans',
  table41: 'crm_grant_bookmarks',
  table42: 'crm_grant_announcements',
  table43: 'crm_recruitment_applicants',
  table44: 'crm_financial_statements',
  table45: 'safety_inspect_logs',
  table46: 'safety_near_misses',
  table47: 'safety_tbm_logs',
  table48: 'safety_risk_assessments',
  table49: 'safety_policies',
  table50: 'crm_employment_certificate_logs',
  table51: 'form_mappings',
  table52: 'form_templates',
  table53: 'ai_contextual_help',
  table54: 'system_mail_logs',
  table55: 'system_menu_settings',
  table56: 'shared_dashboards',
  table57: 'expense_projects',
  table58: 'expense_employees',
  table59: 'expense_departments',
  table60: 'expense_tags',
  table61: 'expense_categories',
  table62: 'expense_settings',
  table63: 'inventory_logs',
  table64: 'alert_logs',
  table65: 'alert_rules',
  table66: 'price_histories',
  table67: 'target_urls',
  table68: 'tracked_items',
  table69: 'ai_token_usage_logs',
  table70: 'crm_inventory_inbound_items',
  table71: 'crm_inventory_inbounds',
  table72: 'inventory_items',
  table73: 'crm_partner_contacts',
  table74: 'crm_snaptask_actions',
  table75: 'crm_snaptask_items',
  table76: 'crm_snaptasks',
  table77: 'crm_partners',
  table78: 'crm_sales_orders',
  table79: 'crm_purchase_orders',
  table80: 'crm_estimate_items',
  table81: 'crm_estimates',
  table82: 'crm_point_history',
  table83: 'crm_coupons_restrictions',
  table84: 'coupons',
  table85: 'naver_blog_marketing_settings',
  table86: 'crm_naver_blog_posts',
  table87: 'instagram_marketing_settings',
  table88: 'crm_instagram_posts',
  table89: 'crm_operators',
  table90: 'crm_deliveries',
  table91: 'crm_reservations',
  table92: 'crm_payments',
  table93: 'crm_orders',
  table94: 'crm_transactions',
  table95: 'products',
  table96: 'ad_templates',
  table97: 'message_logs',
  table98: 'message_templates',
  table99: 'crm_web_form_logs',
  table100: 'crm_web_templates',
  table101: 'system_settings',
  table102: 'crm_customers',
  table103: 'crm_finance_forecasts',
  table104: 'crm_finance_products',
  table105: 'crm_facility_layout',
  table106: 'crm_facility_oee_downtime',
  table107: 'crm_facility_oee_stats',
  table108: 'crm_facility_parts',
  table109: 'crm_facility_events',
  table110: 'crm_production_due_risk',
  table111: 'crm_production_bottlenecks',
  table112: 'crm_production_unscheduled_orders',
  table113: 'crm_production_gantt_tasks',
  table114: 'crm_partner_credit_risks',
  table115: 'crm_labor_contracts',
  table116: 'crm_labor_stats',
  table117: 'crm_scm_suppliers',
  table118: 'crm_scm_shipments',
  table119: 'crm_safety_zones',
  table120: 'crm_safety_alerts',
  table121: 'crm_energy_equipments',
  table122: 'crm_energy_savings',
  table123: 'pms_projects',
  table124: 'ecount_rpa_lock',
  table125: 'ecount_sync_schedules',
  table126: 'crm_company_event_types',
  table127: 'crm_operator_ai_briefing_histories',
  table128: 'crm_operator_projects',
  table129: 'crm_operator_job_history',
  table130: 'crm_operator_families',
  table131: 'crm_operator_reputations',
  table132: 'crm_operator_incidents',
  table133: 'crm_operator_medical',
  table134: 'crm_operator_family_events',
  table135: 'crm_operator_awards',
  table136: 'crm_operator_promotions',
  table137: 'crm_operator_salaries',
  table138: 'crm_operator_careers',
  table139: 'crm_operator_licenses',
  table140: 'crm_operator_education',
  table141: 'crm_operator_profiles',
  table142: 'crm_operator_contract_settings',
  table143: 'crm_company_events',
  table144: 'crm_operator_leave_balances',
  table145: 'crm_annual_leaves',
  table146: 'crm_attendance',
  table147: 'user_feedbacks',
  table148: 'tenant_menu_settings',
  table149: 'exchange_rate_histories',
  table150: 'exchange_rates'
} as const;
