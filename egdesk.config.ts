 ...
 * Generated at: 2026-06-23T15:42:43.212Z
 *
...
export const TABLE_NAMES = {
  table1: 'crm_sales_orders',
  table2: 'crm_estimates',
  table3: 'crm_expenses',
  table4: 'crm_partner_ai_reports',
  table5: 'crm_grant_announcements',
  table6: 'system_shared_views',
  table7: 'user_data_embedding_metadata',
  table8: 'user_data_embeddings',
  table9: 'sync_activity_log',
  table10: 'sync_configurations',
  table11: 'user_data_files',
  table12: 'crm_interpretation_logs',
  table13: 'crm_interpretation_sessions',
  table14: 'easybot_rules_history',
  table15: 'easybot_rules',
  table16: 'crm_financial_analysis_logs',
  table17: 'crm_financial_statement_items',
  table18: 'easybot_action_audit_logs',
  table19: 'crm_web_published_sites',
  table20: 'crm_deadstock_proposals',
  table21: 'crm_meeting_tasks',
  table22: 'crm_meetings',
  table23: 'exchange_rates',
  table24: 'tenant_menu_settings',
  table25: 'exchange_rate_histories',
  table26: 'user_feedbacks',
  table27: 'crm_attendance',
  table28: 'crm_operator_leave_balances',
  table29: 'crm_annual_leaves',
  table30: 'crm_company_events',
  table31: 'crm_operator_contract_settings',
  table32: 'crm_operator_profiles',
  table33: 'crm_operator_licenses',
  table34: 'crm_operator_education',
  table35: 'crm_operator_careers',
  table36: 'crm_operator_salaries',
  table37: 'crm_operator_awards',
  table38: 'crm_operator_promotions',
  table39: 'crm_operator_family_events',
  table40: 'crm_operator_incidents',
  table41: 'crm_operator_medical',
  table42: 'crm_operator_reputations',
  table43: 'crm_operator_families',
  table44: 'crm_operator_job_history',
  table45: 'crm_operator_ai_briefing_histories',
  table46: 'crm_operator_projects',
  table47: 'crm_company_event_types',
  table48: 'ecount_sync_schedules',
  table49: 'pms_projects',
  table50: 'ecount_rpa_lock',
  table51: 'crm_energy_savings',
  table52: 'crm_safety_alerts',
  table53: 'crm_energy_equipments',
  table54: 'crm_safety_zones',
  table55: 'crm_scm_shipments',
  table56: 'crm_labor_stats',
  table57: 'crm_scm_suppliers',
  table58: 'crm_labor_contracts',
  table59: 'crm_partner_credit_risks',
  table60: 'crm_production_gantt_tasks',
  table61: 'crm_production_bottlenecks',
  table62: 'crm_production_unscheduled_orders',
  table63: 'crm_production_due_risk',
  table64: 'crm_facility_events',
  table65: 'crm_facility_parts',
  table66: 'crm_facility_oee_downtime',
  table67: 'crm_facility_oee_stats',
  table68: 'crm_facility_layout',
  table69: 'crm_finance_products',
  table70: 'crm_finance_forecasts',
  table71: 'system_settings',
  table72: 'crm_customers',
  table73: 'crm_web_templates',
  table74: 'crm_web_form_logs',
  table75: 'message_templates',
  table76: 'ad_templates',
  table77: 'message_logs',
  table78: 'products',
  table79: 'crm_transactions',
  table80: 'crm_orders',
  table81: 'crm_reservations',
  table82: 'crm_payments',
  table83: 'crm_deliveries',
  table84: 'crm_operators',
  table85: 'crm_instagram_posts',
  table86: 'instagram_marketing_settings',
  table87: 'naver_blog_marketing_settings',
  table88: 'crm_naver_blog_posts',
  table89: 'coupons',
  table90: 'crm_coupons_restrictions',
  table91: 'crm_point_history',
  table92: 'crm_estimate_items',
  table93: 'crm_purchase_orders',
  table94: 'crm_snaptasks',
  table95: 'crm_partners',
  table96: 'crm_snaptask_items',
  table97: 'crm_snaptask_actions',
  table98: 'crm_partner_contacts',
  table99: 'inventory_items',
  table100: 'crm_inventory_inbounds',
  table101: 'ai_token_usage_logs',
  table102: 'crm_inventory_inbound_items',
  table103: 'tracked_items',
  table104: 'target_urls',
  table105: 'alert_rules',
  table106: 'price_histories',
  table107: 'alert_logs',
  table108: 'inventory_logs',
  table109: 'expense_settings',
  table110: 'expense_tags',
  table111: 'expense_categories',
  table112: 'expense_departments',
  table113: 'expense_projects',
  table114: 'expense_employees',
  table115: 'shared_dashboards',
  table116: 'system_mail_logs',
  table117: 'system_menu_settings',
  table118: 'ai_contextual_help',
  table119: 'form_templates',
  table120: 'crm_employment_certificate_logs',
  table121: 'form_mappings',
  table122: 'safety_policies',
  table123: 'safety_risk_assessments',
  table124: 'safety_near_misses',
  table125: 'safety_tbm_logs',
  table126: 'safety_inspect_logs',
  table127: 'crm_recruitment_applicants',
  table128: 'crm_financial_statements',
  table129: 'crm_grant_bookmarks',
  table130: 'crm_grant_rnd_plans',
  table131: 'crm_grant_company_profile',
  table132: 'crm_quality_checklist_submissions',
  table133: 'crm_quality_ncr_similar_cases',
  table134: 'crm_quality_ncr_items',
  table135: 'crm_quality_sensors_status',
  table136: 'crm_quality_sensors_contribution',
  table137: 'crm_quality_spc_config',
  table138: 'crm_quality_sensors_timeline',
  table139: 'crm_quality_spc_samples',
  table140: 'crm_quality_spc_features',
  table141: 'crm_quality_spc_predictions',
  table142: 'crm_quality_vision_model',
  table143: 'crm_facilities',
  table144: 'crm_quality_vision_logs',
  table145: 'crm_facility_checklists',
  table146: 'crm_facility_repair_logs',
  table147: 'crm_facility_predictive_summary',
  table148: 'crm_facility_repair_solutions',
  table149: 'crm_facility_predictive_vibration',
  table150: 'crm_facility_predictive_part_rul',
  table151: 'crm_facility_predictive_fft',
  table152: 'rnd_centers',
  table153: 'rnd_staffs',
  table154: 'rnd_logs',
  table155: 'rnd_spaces',
  table156: 'rnd_compliance_alarms',
