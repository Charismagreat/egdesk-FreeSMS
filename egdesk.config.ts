 ...
 * Generated at: 2026-06-29T00:46:55.929Z
 *
...
export const TABLE_NAMES = {
  table1: 'crm_governance_logs',
  table2: 'rnd_compliance_alarms',
  table3: 'rnd_logs',
  table4: 'rnd_spaces',
  table5: 'rnd_staffs',
  table6: 'rnd_centers',
  table7: 'crm_facility_predictive_part_rul',
  table8: 'crm_facility_predictive_fft',
  table9: 'crm_facility_predictive_vibration',
  table10: 'crm_facility_predictive_summary',
  table11: 'crm_facility_repair_solutions',
  table12: 'crm_facility_repair_logs',
  table13: 'crm_facility_checklists',
  table14: 'crm_facilities',
  table15: 'crm_quality_vision_logs',
  table16: 'crm_quality_vision_model',
  table17: 'crm_quality_spc_features',
  table18: 'crm_quality_spc_predictions',
  table19: 'crm_quality_spc_samples',
  table20: 'crm_quality_spc_config',
  table21: 'crm_quality_sensors_timeline',
  table22: 'crm_quality_sensors_contribution',
  table23: 'crm_quality_sensors_status',
  table24: 'crm_quality_ncr_similar_cases',
  table25: 'crm_quality_ncr_items',
  table26: 'crm_quality_checklist_submissions',
  table27: 'crm_grant_company_profile',
  table28: 'crm_grant_rnd_plans',
  table29: 'crm_grant_bookmarks',
  table30: 'crm_recruitment_applicants',
  table31: 'crm_financial_analysis_logs',
  table32: 'crm_financial_statement_items',
  table33: 'crm_financial_statements',
  table34: 'safety_inspect_logs',
  table35: 'safety_near_misses',
  table36: 'safety_tbm_logs',
  table37: 'safety_risk_assessments',
  table38: 'safety_policies',
  table39: 'ai_contextual_help',
  table40: 'system_mail_logs',
  table41: 'system_menu_settings',
  table42: 'shared_dashboards',
  table43: 'expense_employees',
  table44: 'expense_departments',
  table45: 'expense_tags',
  table46: 'expense_categories',
  table47: 'expense_settings',
  ...
  table56: 'crm_partner_contacts',
  table57: 'crm_snaptask_actions',
  table58: 'crm_snaptask_items',
  table59: 'crm_snaptasks',
  table60: 'crm_sales_orders',
  table61: 'crm_purchase_orders',
  table62: 'crm_point_history',
  table63: 'crm_coupons_restrictions',
  table64: 'naver_blog_marketing_settings',
  table65: 'crm_naver_blog_posts',
  table66: 'instagram_marketing_settings',
  table67: 'crm_instagram_posts',
  table68: 'crm_operators',
  table69: 'system_settings',
  table70: 'crm_transactions',
  table71: 'ad_templates',
  table72: 'message_logs',
  table73: 'message_templates',
  table74: 'crm_customers',
  table75: 'crm_expenses',
  table76: 'crm_estimate_items',
  table77: 'crm_estimates',
  table78: 'crm_partner_ai_reports',
  table79: 'crm_grant_announcements',
  table80: 'system_shared_views',
  table81: 'user_data_embedding_metadata',
  table82: 'user_data_embeddings',
  table83: 'sync_activity_log',
  table84: 'sync_configurations',
  table85: 'user_data_files',
  table86: 'crm_interpretation_logs',
  table87: 'crm_interpretation_sessions',
  table88: 'easybot_rules_history',
  table89: 'easybot_rules',
  table90: 'easybot_action_audit_logs',
  table91: 'crm_web_published_sites',
  table92: 'crm_deadstock_proposals',
  table93: 'crm_meeting_tasks',
  table94: 'crm_meetings',
  table95: 'exchange_rates',
  table96: 'tenant_menu_settings',
  table97: 'exchange_rate_histories',
  table98: 'user_feedbacks',
  table99: 'crm_attendance',
  table100: 'crm_operator_leave_balances',
  table101: 'crm_annual_leaves',
  table102: 'crm_company_events',
  table103: 'crm_operator_contract_settings',
  table104: 'crm_operator_profiles',
  table105: 'crm_operator_licenses',
  table106: 'crm_operator_education',
  table107: 'crm_operator_careers',
  table108: 'crm_operator_salaries',
  table109: 'crm_operator_awards',
  table110: 'crm_operator_promotions',
  table111: 'crm_operator_family_events',
  table112: 'crm_operator_incidents',
  table113: 'crm_operator_medical',
  table114: 'crm_operator_reputations',
  table115: 'crm_operator_families',
  table116: 'crm_operator_job_history',
  table117: 'crm_operator_ai_briefing_histories',
  table118: 'crm_operator_projects',
  table119: 'crm_company_event_types',
  table120: 'ecount_sync_schedules',
  table121: 'pms_projects',
  table122: 'ecount_rpa_lock',
  table123: 'crm_energy_savings',
  table124: 'crm_safety_alerts',
  table125: 'crm_energy_equipments',
  table126: 'crm_safety_zones',
  table127: 'crm_scm_shipments',
  table128: 'crm_labor_stats',
  table129: 'crm_scm_suppliers',
  table130: 'crm_labor_contracts',
  table131: 'crm_partner_credit_risks',
  table132: 'crm_production_gantt_tasks',
  table133: 'crm_production_bottlenecks',
  table134: 'crm_production_unscheduled_orders',
  table135: 'crm_production_due_risk',
  table136: 'crm_facility_events',
  table137: 'crm_facility_parts',
  table138: 'crm_facility_oee_downtime',
  table139: 'crm_facility_oee_stats',
  table140: 'crm_facility_layout',
  table141: 'crm_finance_products',
  table142: 'crm_finance_forecasts',
  table143: 'crm_web_templates',
  table144: 'crm_web_form_logs',
  table145: 'products',
  table146: 'crm_orders',
  table147: 'crm_reservations',
  table148: 'crm_payments',
  table149: 'crm_deliveries',
  table150: 'coupons',
  table151: 'crm_partners',
  table152: 'inventory_items',
  table153: 'ai_token_usage_logs',
  table154: 'expense_projects',
  table155: 'form_templates',
  table156: 'crm_employment_certificate_logs',
  table157: 'form_mappings',
  table158: 'crm_credential_vault',
  table159: 'crm_credential_emergency_requests',
  table160: 'crm_credential_audit_logs'
} as const;
