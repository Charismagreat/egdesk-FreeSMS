 ...
 * Generated at: 2026-06-20T00:57:06.502Z
 *
...
export const TABLE_NAMES = {
  table1: 'crm_interpretation_logs',
  table2: 'crm_interpretation_sessions',
  table3: 'crm_meeting_tasks',
  table4: 'crm_meetings',
  table5: 'crm_deadstock_proposals',
  table6: 'crm_web_published_sites',
  table7: 'easybot_rules_history',
  table8: 'easybot_rules',
  table9: 'crm_financial_analysis_logs',
  table10: 'crm_financial_statement_items',
  table11: 'easybot_action_audit_logs',
  table12: 'crm_credential_audit_logs',
  table13: 'crm_credential_emergency_requests',
  table14: 'crm_credential_vault',
  table15: 'rnd_compliance_alarms',
  table16: 'rnd_logs',
  table17: 'rnd_spaces',
  table18: 'rnd_staffs',
  table19: 'rnd_centers',
  table20: 'crm_facility_predictive_part_rul',
  table21: 'crm_facility_predictive_fft',
  table22: 'crm_facility_predictive_vibration',
  table23: 'crm_facility_predictive_summary',
  table24: 'crm_facility_repair_solutions',
  table25: 'crm_facility_repair_logs',
  table26: 'crm_facility_checklists',
  table27: 'crm_facilities',
  table28: 'crm_quality_vision_logs',
  table29: 'crm_quality_vision_model',
  table30: 'crm_quality_spc_features',
  table31: 'crm_quality_spc_predictions',
  table32: 'crm_quality_spc_samples',
  table33: 'crm_quality_spc_config',
  table34: 'crm_quality_sensors_timeline',
  table35: 'crm_quality_sensors_contribution',
  table36: 'crm_quality_sensors_status',
  table37: 'crm_quality_ncr_similar_cases',
  table38: 'crm_quality_ncr_items',
  table39: 'crm_quality_checklist_submissions',
  table40: 'crm_grant_company_profile',
  table41: 'crm_grant_rnd_plans',
  table42: 'crm_grant_bookmarks',
  table43: 'crm_grant_announcements',
  table44: 'crm_recruitment_applicants',
  ...
  table51: 'crm_employment_certificate_logs',
  table52: 'form_mappings',
  table53: 'form_templates',
  table54: 'ai_contextual_help',
  table55: 'system_mail_logs',
  table56: 'system_menu_settings',
  table57: 'shared_dashboards',
  table58: 'expense_projects',
  table59: 'expense_employees',
  table60: 'expense_departments',
  table61: 'expense_tags',
  table62: 'expense_categories',
  table63: 'expense_settings',
  table64: 'crm_expenses',
  table65: 'inventory_logs',
  table66: 'alert_logs',
  table67: 'alert_rules',
  table68: 'price_histories',
  table69: 'target_urls',
  table70: 'tracked_items',
  table71: 'ai_token_usage_logs',
  table72: 'crm_inventory_inbound_items',
  table73: 'crm_inventory_inbounds',
  table74: 'inventory_items',
  table75: 'crm_partner_contacts',
  table76: 'crm_snaptask_actions',
  table77: 'crm_snaptask_items',
  table78: 'crm_snaptasks',
  table79: 'crm_partners',
  table80: 'crm_sales_orders',
  table81: 'crm_purchase_orders',
  table82: 'crm_estimate_items',
  table83: 'crm_estimates',
  table84: 'crm_point_history',
  table85: 'crm_coupons_restrictions',
  table86: 'coupons',
  table87: 'naver_blog_marketing_settings',
  table88: 'crm_naver_blog_posts',
  table89: 'instagram_marketing_settings',
  table90: 'crm_instagram_posts',
  table91: 'crm_operators',
  table92: 'crm_deliveries',
  table93: 'crm_reservations',
  table94: 'crm_payments',
  table95: 'crm_orders',
  table96: 'crm_transactions',
  table97: 'products',
  table98: 'ad_templates',
  table99: 'message_logs',
  table100: 'message_templates',
  table101: 'crm_web_form_logs',
  table102: 'crm_web_templates',
  table103: 'system_settings',
  table104: 'crm_customers',
  table105: 'crm_finance_forecasts',
  table106: 'crm_finance_products',
  table107: 'crm_facility_layout',
  table108: 'crm_facility_oee_downtime',
  table109: 'crm_facility_oee_stats',
  table110: 'crm_facility_parts',
  table111: 'crm_facility_events',
  table112: 'crm_production_due_risk',
  table113: 'crm_production_bottlenecks',
  table114: 'crm_production_unscheduled_orders',
  table115: 'crm_production_gantt_tasks',
  table116: 'crm_partner_credit_risks',
  table117: 'crm_labor_contracts',
  table118: 'crm_labor_stats',
  table119: 'crm_scm_suppliers',
  table120: 'crm_scm_shipments',
  table121: 'crm_safety_zones',
  table122: 'crm_safety_alerts',
  table123: 'crm_energy_equipments',
  table124: 'crm_energy_savings',
  table125: 'pms_projects',
  table126: 'ecount_rpa_lock',
  table127: 'ecount_sync_schedules',
  table128: 'crm_company_event_types',
  table129: 'crm_operator_ai_briefing_histories',
  table130: 'crm_operator_projects',
  table131: 'crm_operator_job_history',
  table132: 'crm_operator_families',
  table133: 'crm_operator_reputations',
  table134: 'crm_operator_incidents',
  table135: 'crm_operator_medical',
  table136: 'crm_operator_family_events',
  table137: 'crm_operator_awards',
  table138: 'crm_operator_promotions',
  table139: 'crm_operator_salaries',
  table140: 'crm_operator_careers',
  table141: 'crm_operator_licenses',
  table142: 'crm_operator_education',
  table143: 'crm_operator_profiles',
  table144: 'crm_operator_contract_settings',
  table145: 'crm_company_events',
  table146: 'crm_operator_leave_balances',
  table147: 'crm_annual_leaves',
  table148: 'crm_attendance',
  table149: 'user_feedbacks',
  table150: 'tenant_menu_settings',
  table151: 'exchange_rate_histories',
  table152: 'exchange_rates'
} as const;
