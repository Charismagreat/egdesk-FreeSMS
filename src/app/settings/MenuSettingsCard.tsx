...
import { 
  ...
  ChevronUp, ChevronDown, Check, Save, ShieldAlert, GripVertical, Shield, CheckSquare, Wrench
} from "lucide-react";
...
const MENU_METADATA_MAP: Record<string, { label: string; icon: any; color: string }> = {
  ...
  "/finance-cashflow": { label: "자금/원가 AI 시뮬레이터", icon: Coins, color: "text-amber-550" }
};
