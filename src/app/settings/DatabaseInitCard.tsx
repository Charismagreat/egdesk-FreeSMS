...
import { Database, ShieldAlert, CheckCircle2, AlertCircle, RefreshCw, ExternalLink, ChevronDown, ChevronUp } from 'lucide-react';
...
export default function DatabaseInitCard() {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md">
      ...
      {/* 카드 헤더 */}
      <div className="p-6 flex items-center justify-between bg-gradient-to-r from-slate-50 to-emerald-50/10">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl border border-slate-200 text-slate-650 hover:bg-slate-55/60 active:scale-95 transition-all text-xs font-bold cursor-pointer bg-white"
          >
            <span>{isExpanded ? '도구 접기' : '설정 도구 보기'}</span>
      ...
      {/* 접고 열리는 도구 영역 바디 */}
      {isExpanded && (
        <div className="p-6 space-y-6 border-t border-slate-100 animate-fade-in">
