...
const FAQ_DATABASE: FAQItem[] = [
  ...
  },
  {
    id: "order-12",
    category: "order",
    question: "견적서 테이블에 표시되는 AI 스캔 신뢰도 뱃지와 단가 오차 가이드는 어떤 정보인가요?",
    answer: "Gemini AI가 이미지/PDF 분석 후 신뢰도를 안전(초록), 주의(주황), 위험(빨강) 등의 신호등 뱃지로 알려주어 검토가 필요한 필드를 미리 시각화합니다. 또한 총 견적액 하단에 기준 품목 단가와의 오차율(예: +5% 💡)을 알려주어, 기존보다 비정상적으로 높게 또는 낮게 잡힌 단가 리스크를 직관적으로 상시 검수할 수 있습니다."
  },
  // 6. 가격 & 마진 추적 AI FAQ
  {
    id: "price-1",
