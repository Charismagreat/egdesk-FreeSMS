...
export const FAQ_DATABASE: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "PC 시뮬레이터 화면의 슬라이더를 통해 원달러 환율(1,200원~1,500원), 수입 원자재가 상승률(0%~50%), 공장 노무비율(0%~30%)을 조절하는 즉시 백엔드 시뮬레이션 엔진이 작동하여 제품 단위당 원가 구성을 실시간 재계산합니다. 수입 부품의 경우 환율과 자재가 인상률이 곱해져 재료비 상승으로 반영되며, 노무비는 임금 상승률만큼 가중 가산됩니다. 연산 완료 시 제품별 순이익 마진율이 실시간으로 하락하거나 상승하는 것을 스택트 원가 바 그래프로 시각화해 주며, 마진율이 10% 미만으로 폭락하는 적색 위험 경보 시 즉각 제품 판매가 인상 조치 필요 가이드를 제공합니다."
  }
];
