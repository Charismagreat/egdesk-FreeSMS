        ...
        <div className="xl:col-span-1 bg-white rounded-2xl shadow-sm border border-slate-100 p-5 overflow-hidden flex flex-col">
          ...
          <div className="relative mb-3.5 shrink-0">
            <input
              ...
              className="w-full pl-8 pr-7 py-2 text-xs bg-slate-50 hover:bg-slate-100/50 focus:bg-white text-slate-700 placeholder-slate-400 border border-slate-250 focus:border-blue-400 focus:ring-1 focus:ring-blue-100 rounded-xl outline-none transition-all font-semibold"
            />
            <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-400" />
            {tableSearchQuery && (
              <button
                onClick={() => setTableSearchQuery('')}
                className="absolute right-2 top-1/2 -translate-y-1/2 p-0.5 hover:bg-slate-200 text-slate-400 hover:text-slate-650 rounded-full border-none bg-transparent cursor-pointer transition-all"
              >
