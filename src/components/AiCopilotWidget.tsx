              ...
              <div className="space-y-4">
                ...
                {omniChannel === "blog" && (
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/60 space-y-3 shadow-sm">
                    ...
                    <div className="text-[11px] text-slate-650 leading-relaxed whitespace-pre-wrap bg-white p-3 rounded-lg max-h-48 overflow-y-auto border border-slate-200/45 shadow-inner">
                    ...
                    <div className="text-[9px] text-slate-500 bg-slate-100 p-2 rounded-lg border border-slate-200/50 leading-normal">
                ...
                {omniChannel === "instagram" && (
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-200/60 space-y-3 shadow-sm">
                    <div>
                      ...
                      <div className="text-[11px] text-slate-650 leading-relaxed whitespace-pre-wrap bg-white p-3 rounded-lg max-h-40 overflow-y-auto border border-slate-200/45 shadow-inner">
                    ...
                    <div className="space-y-2">
                      {contentPack.shorts.sceneList.map((scene, idx) => (
                        <div key={idx} className="bg-white p-2.5 rounded-lg border border-slate-200 grid grid-cols-1 md:grid-cols-4 gap-1.5">
                          ...
                          <div className="md:col-span-2 text-[10px] text-slate-650">
                            <b>🎬 화면:</b> {scene.visualDescription}
                          </div>
                          <div className="text-[10px] text-slate-800 italic font-bold bg-slate-100 p-2 rounded border border-slate-200/60 leading-normal">
                            🎙️ "{scene.voiceScript}"
                          </div>
                        </div>
                      ))}
